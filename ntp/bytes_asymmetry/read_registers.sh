...
echo "register_read dropped_packets_counter 0" | $CLI_PATH ntp_bytes_asymmetry.json 22222 | grep dropped_packets_counter
echo "register_read ntp_counter 0" | $CLI_PATH ntp_bytes_asymmetry.json 22222 | grep ntp_counter
echo "register_read data_bytes 0" | $CLI_PATH ntp_bytes_asymmetry.json 22222 | grep data_bytes
